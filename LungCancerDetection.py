...
def preprocess():
    ...
    text.insert(END, "Total process images from dataset is : " +
                str(X.shape[0])+"\n")
    img = X[0]
...
def buildCNN():
    ...
    if os.path.exists('model/model.json'):
        ...
        classifier.load_weights("C:/Users/91934/Desktop/LungCancer/model/model_weights.h5")
        ...
        hist = classifier.fit(X, Y, batch_size=16,
...
def predict():
    ...
    if predict == 0:
        ...
        cv2.putText(img1, 'CT-Scan Predicted as : ' +
                    labels[predict], (10, 25),  cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
...
predictButton = Button(
    main, text="Upload Test Image & Predict Cancer", command=predict)
